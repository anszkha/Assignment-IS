...
class Visitor {
	static async injectDB(conn) {
		visitors = await conn.db("Office_VMS").collection("visitors")
	}
	 ...
	 * @param {*} phone 
	 */
	static async register(username, password, name, age, gender, reason, telno) {
	...
	static async login(username, password) {
		...
		static async update(username, name, age, gender, reason,telno){
